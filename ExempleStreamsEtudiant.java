...
//        // 5. AVERAGE - Calculer la moyenne générale de la classe
        ...
        // mapToDouble() : transforme chaque etudiant en double
        // average() : calcule la moyenne de tous les doubles
        // orElse(0.0) : renvoie 0.0 si la liste est vide
...
//        // 6. MAX/MIN - Meilleur et moins bon étudiant
        ...
        // Comparator.comparing() : compare les etudiants selon leur moyenne
        // max() : renvoie un Optional<Etudiant> (vide si la liste est vide)
...
//        // 7. ANYMATCH - Vérifier si au moins un étudiant a échoué
        ...
        // anyMatch() : renvoie true si AU MOINS un element correspond au test
...
//        // 8. COLLECT - Grouper par mention
        ...
        // groupingBy() : regroupe les etudiants selon une cle definie ici
...
//        // 9. LIMIT & SKIP - Top 3 des meilleurs étudiants
        ...
        // sorted() : tri selon la moyenne décroissante
        // limit(3) : ne garde que les 3 premiers
...
//        // 10. DISTINCT - Extraire les domaines email uniques
        ...
        // map() : transforme chaque etudiant en domaine email
...
//        // 11. REDUCE - Calculer la somme des moyennes manuellement
        ...
        // reduce() : additionne toutes les moyennes une à une
...
//        // 12. ALLMATCH - Vérifier si tous les étudiants ont une adresse email
        ...
        // allMatch() : teste si TOUS les étudiants ont une adresse non vide
...
//        // 13. PARALLEL STREAM - Traitement parallèle pour grandes listes
        ...
        // parallelStream() : exécute les calculs sur plusieurs threads (plus rapide pour grandes listes)
...
//        // 14. COLLECT avec Collectors personnalisés
        ...
        // summarizingDouble() : renvoie un objet avec count, average, min, max, sum
